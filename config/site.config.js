...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'tiianshi@tianshisama.onmicrosoft.com',
  ...
  email: 'mailto:admin@tiangal.com',
